...
const CustomSignInPage = () => {
  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      ...
      console.error("Error during sign-in:", err.errors[0].message);
    }
  };
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      await signIn.authenticateWithRedirect({
        ...
        // The afterSignInUrl will be used after successful sign-in
      });
    } catch (err) {
    ...
    <div className="w-full min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-950 from-35% via-eagle via-55% to-gray-950 to-75% relative overflow-hidden">
      ...
      >
        <Card className="bg-gray-900 border-gray-800">
          <CardHeader>
            <CardTitle className="text-2xl font-bold text-white">Sign In to Garuda</CardTitle>
            <CardDescription className="text-neutral-300">
              Access AI-powered disaster response and analysis.
            </CardDescription>
          </CardHeader>
          <CardContent>
